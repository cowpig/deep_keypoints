...
# quickly test new code for bugs
...
s_train = theano.shared(data[:n_train], borrow=True)
s_labels = theano.shared(labels[:n_train], borrow=True)
...
# conv_layer_test = conv.ConvLayer(inputs=initial_input, filter_shape=(50, 1, 4, 4),
# 							image_shape=(batch_size, 1) + img_shape,
# 							activation=theano.tensor.nnet.sigmoid, poolsize=(2, 2))
# nn_layer_test = nn.NNLayer(inputs=conv_to_nn, n_in=framesize, n_out=96*96, 
# 						activation=theano.tensor.nnet.sigmoid)
